...
@yanz = Company.create!(:area => "兖州区", :name => "中铁市政环境建设有限公司")
...
@yzsw  = Factory.create!(:area => "兖州区",     :name => "中铁市政环境建设有限公司",       :company => @yanz, :lnt => 116.78365, :lat => 35.551938, :design => 60000)
...
User.create!(:phone => "053701011818", :password => "yznwgc0101", :password_confirmation => "yznwgc0101", :name => "中铁市政环境建设有限公司管理者",     :roles => @fctmgn,    :factories => [@yzsw])
