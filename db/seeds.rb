...
@lssw = Company.create!(:area => "梁山县", :name => "梁山农污工程建设")
@jiax = Company.create!(:area => "嘉祥县", :name => "嘉祥农污工程建设")
...
@zouc = Company.create!(:area => "邹城市", :name => "邹城农污工程建设")
...
@lssw  = Factory.create!(:area => "梁山县",     :name => "梁山农污工程建设",       :company => @lssw, :lnt => 116.131779, :lat => 35.765957, :design => 20000)
@zcsw  = Factory.create!(:area => "邹城市",     :name => "邹城农污工程建设",       :company => @zouc, :lnt => 117.007406, :lat => 35.402536, :design => 80000)
@jxsw  = Factory.create!(:area => "嘉祥县",     :name => "嘉祥农污工程建设",       :company => @jiax, :lnt => 116.342308, :lat => 35.40794, :design => 80000)
...
User.create!(:phone => "053701013708", :password => "lsnwgc0101", :password_confirmation => "lsnwgc0101", :name => "梁山农污工程建设管理者",     :roles => @fctmgn,    :factories => [@lssw])
User.create!(:phone => "053709096688", :password => "zcnwgc0909", :password_confirmation => "zcnwgc0909", :name => "邹城农污工程建设管理者",     :roles => @fctmgn,    :factories => [@zcsw])
User.create!(:phone => "053745671111", :password => "jxnwgc4567", :password_confirmation => "jxnwgc4567", :name => "嘉祥农污工程建设管理者",     :roles => @fctmgn,    :factories => [@jxsw])
